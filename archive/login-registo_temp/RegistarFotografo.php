...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO fotografo (nome, email, foto, password, certificado) VALUES ('$nome','$email','$foto','$pass','$certificado')";
...
<html lang="pt-PT">
    <head>
        ...
        <meta charset="utf-8" />
        <title>RegistarFotografo</title>
        <link rel="stylesheet" href="css/RegistarFotografo.css" />
    </head>
    <body>
        <div class="registar-fotografo-container">
            <!-- Painel Esquerdo -->
                ...
                <form class="registro-form">
                    ...
                    <div class="form-group">
                        ...
                        <label for="certificado" class="file-upload-label">
                            ...
                            <span class="upload-text">Faz upload de um ficheiro ou arrasta para aqui.</span>
                            <span class="upload-info">pdf, jpeg, png - até 50MB</span>
                        </label>
                        <input type="file" id="certificado" name="certificado" accept=".pdf,.jpeg,.jpg,.png" required style="display: none;">
                    </div>
        ...
        <script>
            function togglePassword() {   // funçao para mostrar/ocultar password
